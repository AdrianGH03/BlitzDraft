...
const tutorials = [
  { image: tutorial1, text: 'Head over to the difficulty page (play button in top right). Click the "Get Game" button to load a game. The button will then show "Game Ready" when your game loads.' },
  ...
  return (
    <>
      <section className="tutorial-container-desktop">
        ...
        <div className="tutorial-desktop-pagination">
