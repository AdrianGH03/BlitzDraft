...
export function DesktopTutorial() {
  const tutorial0 = '/placeholders/download.jpeg'
  ...
  const tutorial4 = '/placeholders/download2.jpeg'
  ...
  const tutorials = [
    ...
    { image: tutorial4, text: 'When all cards are revealed, the game will calculate your score. Cards ARE sorted by role order here. Guess the winning side for an extra 20 points.' },
