...
const tutorials = [
  ...
  { image: tutoriallast2, text: 'The current card will be flashing yellow. To make a guess, select a champion and click the guess button. Revealed champions are blocked by a red border.' },
